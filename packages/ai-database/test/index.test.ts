...
import type { InferEntity } from '../src/index.js'
...
describe('DB integration tests', () => {
  ...
  describe('nouns API', () => {
    ...
    it('lists inferred nouns from schema', async () => {
      ...
      // Expect 5 nouns: BlogPost, Author, and system entities (Noun, Verb, Edge)
      expect(allNouns.length).toBe(5)
    })
