...
describe('Service', () => {
  ...
  describe('calculateHourlyPrice()', () => {
    ...
    it('should throw error for non-hourly pricing', () => {
      ...
      expect(() => calculateHourlyPrice(service, 10)).toThrow('Service must use hourly pricing model')
    })
  ...
  describe('calculateMonthlyRetainer()', () => {
    ...
    it('should throw error for non-hourly pricing', () => {
      ...
      expect(() => calculateMonthlyRetainer(service, 40)).toThrow('Service must use hourly pricing model')
    })
  ...
  describe('validateService()', () => {
    ...
    it('should allow all valid pricing models', () => {
      const pricingModels: ServiceDefinition['pricingModel'][] = ['hourly', 'fixed', 'retainer', 'value-based']
