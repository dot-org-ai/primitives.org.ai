/**
 * Bundled capnweb source for worker_loaders
 *
 * This embeds the capnweb workers bundle so it can be included
 * as a module when creating dynamic workers with worker_loaders.
 *
 * Generated from capnweb@0.2.0/dist/index-workers.js
 */

export const CAPNWEB_SOURCE = `import * as cfw from 'cloudflare:workers';
