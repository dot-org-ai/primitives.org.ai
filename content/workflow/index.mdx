...
The Workflow primitive is implemented in the [`ai-workflows`](/packages/ai-workflows) package:

```bash
npm install ai-workflows
```

See the [package documentation](/packages/ai-workflows) for API reference and additional examples.
