...
The Service primitive is implemented in the [`services-as-software`](/packages/services-as-software) package:

```bash
npm install services-as-software
```

See the [package documentation](/packages/services-as-software) for API reference and additional examples.
