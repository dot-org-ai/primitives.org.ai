...
The Agent primitive is implemented in the [`autonomous-agents`](/packages/autonomous-agents) package:

```bash
npm install autonomous-agents
```

See the [package documentation](/packages/autonomous-agents) for API reference and additional examples.
