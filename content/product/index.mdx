...
The Product primitive is implemented in the [`digital-products`](/packages/digital-products) package:

```bash
npm install digital-products
```

See the [package documentation](/packages/digital-products) for API reference and additional examples.
