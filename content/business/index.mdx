...
The Business primitive is implemented in the [`business-as-code`](/packages/business-as-code) package:

```bash
npm install business-as-code
```

See the [package documentation](/packages/business-as-code) for API reference and additional examples.
