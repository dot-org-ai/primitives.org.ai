...
The Product primitive composes Functions, Databases, Workflows, and Agents into complete, deployable products. It provides the structure for defining capabilities, interfaces, and user experiences declaratively.
