...
The Workflow primitive orchestrates complex processes that span multiple functions, systems, and time horizons. It provides two complementary paradigms: **durable execution** for code-first workflows and **state machines** for explicit state management.
