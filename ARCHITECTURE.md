...
graph TD
    subgraph "Foundation Layer"
        ...
        graphdl["@graphdl/core<br/><i>Entity-graph DSL (ratified binding)</i>"]
    end
...
- `@graphdl/core` (`graphdl`): No workspace deps (Layer 0; the ratified graph-substrate binding per org.ai ADR 0006 — permanent law, not interim)
